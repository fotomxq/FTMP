...
if (!$centerMenuCache) {
    $centerMenuCache = '<div class="masthead clearfix"><div class="inner"><h3 class="masthead-brand">' . $webData['WEB-TITLE'] . ' 中心</h3><ul class="nav masthead-nav"> <li class="active"><a href="../center/index.php" target="_self">首页</a></li><li><a href="#" data-toggle="modal" data-target="#userModal">个人用户</a></li>';
