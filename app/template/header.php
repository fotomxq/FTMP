...
if (!$tempHeaderCache) {
    ...
    <html lang="zh-cn">
      <head>
        ...
        <title>' . $appPages['title'] . ' - ' . $webData['WEB-TITLE'] . '</title>
        ...
        if (isset($pageIncludes['glob']) == true) {
            if (isset($pageIncludes['glob']['css']) == true) {
                foreach ($pageIncludes['glob']['css'] as $v) {
                    $tempHeaderCache .= '<link href="../../includes/assets/css/' . $v . '" rel="stylesheet">';
                }
            }
        }
        if (isset($pageIncludes['template']) == true) {
            if (isset($pageIncludes['template']['css']) == true) {
                foreach ($pageIncludes['template']['css'] as $v) {
                    $tempHeaderCache .= '<link href="../template/assets/css/' . $v . '" rel="stylesheet">';
                }
            }
        }
        if (isset($pageIncludes['app']) == true) {
            if (isset($pageIncludes['app']['css']) == true) {
                foreach ($pageIncludes['app']['css'] as $v) {
                    $tempHeaderCache .= '<link href="../' . $appName . '/assets/css/' . $v . '" rel="stylesheet">';
                }
            }
        }
    }
    $tempHeaderCache .= '<!--[if lt IE 9]><script src="../../includes/assets/js/html5shiv.js"></script><script src="../../includes/assets/js/respond.js"></script>';
            ...
            if (isset($pageIncludes['glob']['ie']) == true) {
                ...
                if (isset($pageIncludes['glob']['ie']['js']) == true) {
                    foreach ($pageIncludes['glob']['ie']['js'] as $v) {
                        $tempHeaderCache .= '<script src="../../includes/assets/js/' . $v . '"></script>';
                    }
                }
            }
        }
            ...
            if (isset($pageIncludes['template']['css']) == true) {
                ...
                if (isset($pageIncludes['template']['ie']['js']) == true) {
                    foreach ($pageIncludes['template']['ie']['js'] as $v) {
                        $tempHeaderCache .= '<script src="../template/assets/js/' . $v . '"></script>';
                    }
                }
            }
        }
            ...
            if (isset($pageIncludes['app']['css']) == true) {
                ...
                if (isset($pageIncludes['app']['ie']['js']) == true) {
                    foreach ($pageIncludes['app']['ie']['js'] as $v) {
                        $tempHeaderCache .= '<script src="../' . $appName . '/assets/js/' . $v . '"></script>';
                    }
                }
            }
        }
    }
    $tempHeaderCache .= '<![endif]--></head><body>';
    $cache->set($tempHeaderCacheKey, $tempHeaderCache);
}
echo $tempHeaderCache;
unset($tempHeaderCacheKey, $tempHeaderCache);
?>