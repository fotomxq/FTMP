...
<div class="masthead clearfix">
    <div class="inner">
        ...
        <ul class="nav masthead-nav">
            ...
            <li><a href="#" data-toggle="modal" data-target="#userModal">个人用户</a></li>
            <?php if ($checkPowers['ADMIN'] === true) { ?><li><a href="#" data-toggle="modal" data-target="#systemModal">系统设置</a></li><?php } ?>
        </ul>
    </div>
</div>